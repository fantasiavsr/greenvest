                                        ...
                                        <div class="row d-flex">
                                            ...
                                            <div class="col-sm form-outline mb-4">
                                                ...
                                                <select type="text" name="status" class="form-control" autofocus>
                                                    ...
                                                    @if ($this_transaksi->status == 'Menunggu Pembayaran') selected @endif>Menunggu Pembayaran</option>
                                                    <option value="Dibatalkan"
                                                    @if ($this_transaksi->status == 'Dibatalkan') selected @endif>Dibatalkan</option>
                                                </select>
                                            </div>
                                        </div>
