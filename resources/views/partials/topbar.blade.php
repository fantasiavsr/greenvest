            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{ asset('img/item-sample1.png') }}" alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{ asset('img/item-sample3.png') }}" alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{ asset('img/item-sample2.png') }}" alt="...">
